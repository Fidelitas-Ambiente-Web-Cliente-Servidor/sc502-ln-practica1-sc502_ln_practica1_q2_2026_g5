const cursos = [ // Listado de cursos del catálogo
    {
...
function filtrarCursos() {
    // filter() para aplicar búsqueda y categoría al mismo tiempo
...
function crearTarjeta(curso) {
    // Arma cada tarjeta con createElement y appendChild
...
function mostrarCursos() {
    ...
    // forEach recorre los cursos que pasaron el filtro
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // input actualiza los resultados mientras se escribe
